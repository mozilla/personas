...
# ***** END LICENSE BLOCK *****
	...
	function send_accept_email($address, $name, $id)
	{
		...
		$message .= "If you have any questions or want more information, please stop by the Persona message boards at http://groups.google.com/group/mozilla-labs-personas/topics and tell us what's on your mind.\n\n";
		$message .= "Best Wishes,\n";
		$message .= "The Personas Team\n";
